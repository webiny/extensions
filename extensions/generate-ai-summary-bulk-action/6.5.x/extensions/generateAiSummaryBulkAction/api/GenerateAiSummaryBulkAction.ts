 ...
 * an optional Project / Writer Persona / Reader Persona (the user's own instructions/tone) —
 * so we don't pick models, decrypt keys, or hardcode a persona here. We just say
 * "summarize this product" and write the result back.
 *
